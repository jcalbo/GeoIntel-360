...
async def summarize_text(req: SummarizeRequest):
    ...
    base_prompt = (
        ...
        f"Expand your explanation on each bullet point to ensure the total response covers AT LEAST 150 words.\n"
        f"Following the bullets, provide a brief 1-sentence paragraph of strategic implications.\n"
        f"CRITICAL: Do NOT start with any introductory phrase or preamble. Begin your response DIRECTLY with the first bullet point.\n"
        ...
        if provider == "anthropic":
            ...
            response = client.models.generate_content(
                ...
                config=genai.types.GenerateContentConfig(
                    ...
                    system_instruction="You are a senior intelligence analyst. Provide comprehensive responses (at least 150 words). Expand your explanation on each bullet point. Begin DIRECTLY with the first bullet point — no introductory text. Format with exactly 3 bullet points, a 1-sentence implication, and related news links if provided. DO NOT STOP mid-sentence."
                )
            )
            ...
            response = await client.chat.completions.create(
                model="gpt-5-mini",
                messages=[
                    {"role": "system", "content": "You are a senior intelligence analyst. Provide comprehensive summaries (at least 150 words). Expand explanations to meet this length. Begin DIRECTLY with the first bullet — no introductory text. Do not leave sentences unfinished."},
    ...
    logger.info(f"Summary generated by {model_used} ({provider}).")
