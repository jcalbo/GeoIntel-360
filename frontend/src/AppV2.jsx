    ...
    <QueryClientProvider client={queryClient}>
      <div className="min-h-screen bg-bg-base text-text-base flex flex-col font-sans transition-colors duration-300">
        ...
        <div className="flex-1 flex overflow-hidden">
          ...
          {/* Left Sidebar */}
          <aside className="w-80 flex-shrink-0 hidden lg:block border-r border-border-subtle overflow-y-auto">
            <SidebarFilter
              dateRange={dateRange}
          ...
          {/* Main Content Area */}
          <main className="flex-1 px-4 sm:px-6 lg:px-8 py-8 w-full flex flex-col gap-8 overflow-y-auto min-h-0">
